...
import classForm from './forms/teacher-form.vue';
...
export default {
    ...
    data(){
        return{
            ...
            dataTable:{
                headers:[
                    {text:'ID Number',value:'instructor_number',width:'5%'},
    ...
    computed:{
        ...mapState("teacher",["teachers","message"]),
    },
    watch:{
        search(){
            setTimeout(()=>{
    ...
    methods:{
        ...mapActions("teacher",["GET_TEACHERS"]),
        initialize(){
            this.GET_TEACHERS_DATA()
        },
        GET_TEACHERS_DATA(){
