                ...
                <v-card-text>
                    <v-row>
                        <v-col
                            ...
                            >
                            <v-text-field
                                v-model="user.learners_number"
                                label="Learners Number"
                                outlined
                                shaped
                                :readonly="true"
                            ></v-text-field>
        ...
        action({action, data, index, message}){
            ...
            switch(action){
                case 'edit':
                    ...
                    this.studentForm = { show: true, action, data: this.user, index: this.user.id}
                break;
                
            }
        },
        closeDialog(){
        studentForm = { ...studentForm, show: false, data: {}}
